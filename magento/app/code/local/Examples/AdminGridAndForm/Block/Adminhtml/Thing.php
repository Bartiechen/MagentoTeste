...
class Examples_AdminGridAndForm_Block_Adminhtml_Thing extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('examples_admingridandform')->__('Dados do Form'); # sets the name in the header
        $this->_addButtonLabel = Mage::helper('examples_admingridandform')->__('Adicionar Novo Contato'); # sets the text for the add button
